...
@section('content')
    <form action="{{ route('peserta.update', $peserta->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nama_lengkap" id="nama_lengkap" class="form-control" value="{{$peserta->nama_lengkap}}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="file" name="kartu_keluarga" id="kartu_keluarga" class="form-control" value="{{$peserta->kartu_keluarga}}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" value="{{$peserta->tempat_lahir}}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="pendidikan_terakhir" id="pendidikan_terakhir" class="form-control" value="{{$peserta->pendidikan_terakhir}}">
        </div>
        <div class="mb-3">
            <label for="nama_sekolah">Nama Sekolah</label>
            <input type="text" name="nama_sekolah" id="nama_sekolah" class="form-control" value="{{$peserta->nama_sekolah}}">
        </div>
        <div class="mb-3">
